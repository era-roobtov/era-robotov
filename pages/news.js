      ...
      news: [
        {
          ...
          imgPath: '/static/new_img/news/1_news.jpg',
          link: 'https://www.instagram.com/p/CTE5fP7ilZP/'
        },
        {
          ...
          imgPath: '/static/new_img/news/2_news.jpg',
          link: 'https://www.instagram.com/p/CTO2SYeAPXW/'
        },
        {
          text: 'Планы на выходные есть? А, если найдем? \n' +
            ...
            'lego - конструирование и программирование робота-футболиста ⚽️\n' +
          ...
          imgPath: '/static/new_img/news/3_news.jpg',
          link: 'https://www.instagram.com/p/CTO2SYeAPXW/'
        },
        {
          text: 'МЫ ОТКРЫЛИСЬ! СКИДКА 15 % НА ЗАНЯТИЯ! \n' +
            '\n' +
            'С радостью сообщаем, что ваши дети смогут начать ходить на занятия уже завтра! \n' +
            'Мы долго этого ждали, много работали и для нас нет ничего важнее, чем открыть для вас двери своей школы!🎓\n' +
            '16 сентября начнет занятия первая группа по изучению Scratch,',
          imgPath: '/static/new_img/news/4_news.jpg',
          link: 'https://www.instagram.com/p/CTO2SYeAPXW/'
        },
        {
          ...
          imgPath: '/static/new_img/news/5_news.jpg',
          link: 'https://www.instagram.com/p/CTO2SYeAPXW/'
        },
        {
          ...
          imgPath: '/static/new_img/news/6_news.jpg',
          link: 'https://www.instagram.com/p/CTO2SYeAPXW/'
        },
        {
          text: 'Каждый родитель желает своему ребёнку лучшего и хочет быть уверен в качестве выбранного образования \n' +
            ...
            '- Мы любим и верим в то, чем занимаемся, поэтому делаем это хорошо! ❤️\n' +
            'Приходите к нам и убедитесь в этом!',
          imgPath: '/static/new_img/news/7_news.jpg',
          link: 'https://www.instagram.com/p/CTO2SYeAPXW/'
        }
      ]
    },
